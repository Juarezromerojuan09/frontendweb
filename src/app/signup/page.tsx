        ...
        <div className="max-w-lg w-full space-y-8">
          ...
          <div className="mt-6">
            <button
              ...
              className="w-full flex items-center justify-center px-4 py-3 border-2 border-[#3ea0c9] rounded-lg text-white bg-transparent hover:bg-[#3ea0c9] hover:bg-opacity-20 transition-colors"
            >
          ...
          <div className="relative mt-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-2 bg-[#000e24] text-[#B7C2D6]">O regístrate con email</span>
            </div>
          </div>
